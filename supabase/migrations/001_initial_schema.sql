...
CREATE INDEX IF NOT EXISTS idx_memberships_active ON company_memberships(active);
...
-- Index
CREATE INDEX IF NOT EXISTS idx_permission_catalog_group ON permission_catalog(group_name);
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_membership_perms_membership ON membership_permissions(membership_id);
CREATE INDEX IF NOT EXISTS idx_membership_perms_key ON membership_permissions(permission_key);
