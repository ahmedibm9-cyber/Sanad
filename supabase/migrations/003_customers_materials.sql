...
CREATE INDEX IF NOT EXISTS idx_customers_active ON customers(company_id, active);
CREATE INDEX IF NOT EXISTS idx_customers_deleted ON customers(company_id, deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_materials_name ON materials(company_id, name);
CREATE INDEX IF NOT EXISTS idx_materials_active ON materials(company_id, active);
CREATE INDEX IF NOT EXISTS idx_materials_deleted ON materials(company_id, deleted_at);
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_material_files_company ON material_files(company_id);
CREATE INDEX IF NOT EXISTS idx_material_files_material ON material_files(material_id);
CREATE INDEX IF NOT EXISTS idx_material_files_type ON material_files(file_type);
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_price_events_company ON material_price_events(company_id);
CREATE INDEX IF NOT EXISTS idx_price_events_material ON material_price_events(material_id);
CREATE INDEX IF NOT EXISTS idx_price_events_recorded ON material_price_events(recorded_at DESC);
