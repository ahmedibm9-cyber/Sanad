...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_report_issues_company ON report_issues(company_id);
CREATE INDEX IF NOT EXISTS idx_report_issues_work_item ON report_issues(work_item_id);
