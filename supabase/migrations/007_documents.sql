...
CREATE UNIQUE INDEX IF NOT EXISTS idx_documents_number_company ON documents(company_id, document_number) WHERE deleted_at IS NULL;

-- Indexes
CREATE INDEX IF NOT EXISTS idx_documents_company ON documents(company_id);
CREATE INDEX IF NOT EXISTS idx_documents_work_item ON documents(work_item_id);
