...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_work_items_company ON work_items(company_id);
CREATE INDEX IF NOT EXISTS idx_work_items_type ON work_items(company_id, type);
CREATE INDEX IF NOT EXISTS idx_work_items_status ON work_items(company_id, status);
CREATE INDEX IF NOT EXISTS idx_work_items_customer ON work_items(company_id, customer_id);
CREATE INDEX IF NOT EXISTS idx_work_items_pinned ON work_items(company_id, pinned) WHERE pinned = TRUE;
CREATE INDEX IF NOT EXISTS idx_work_items_archived ON work_items(company_id, archived_at) WHERE archived_at IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_work_items_active ON work_items(company_id, active);
CREATE INDEX IF NOT EXISTS idx_work_items_deleted ON work_items(company_id, deleted_at);
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_work_item_materials_company ON work_item_materials(company_id);
CREATE INDEX IF NOT EXISTS idx_work_item_materials_work_item ON work_item_materials(work_item_id);
CREATE INDEX IF NOT EXISTS idx_work_item_materials_material ON work_item_materials(material_id);
