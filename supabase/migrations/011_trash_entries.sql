...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_trash_company ON trash_entries(company_id);
CREATE INDEX IF NOT EXISTS idx_trash_entity ON trash_entries(entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_trash_deleted ON trash_entries(deleted_at DESC);
