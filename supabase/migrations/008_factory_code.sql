...
CREATE UNIQUE INDEX IF NOT EXISTS idx_factory_code_source_key ON factory_code_records(stable_source_key);

-- Indexes for search
CREATE INDEX IF NOT EXISTS idx_factory_code_code ON factory_code_records(factory_code);
CREATE INDEX IF NOT EXISTS idx_factory_code_name ON factory_code_records(factory_name);
CREATE INDEX IF NOT EXISTS idx_factory_code_city ON factory_code_records(city);
CREATE INDEX IF NOT EXISTS idx_factory_code_region ON factory_code_records(region);
CREATE INDEX IF NOT EXISTS idx_factory_code_product ON factory_code_records(product);
CREATE INDEX IF NOT EXISTS idx_factory_code_hs ON factory_code_records(hs_code);
CREATE INDEX IF NOT EXISTS idx_factory_code_activity ON factory_code_records(activity);

-- Full-text search index
CREATE INDEX IF NOT EXISTS idx_factory_code_search ON factory_code_records 
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_factory_imports_status ON factory_code_imports(status);
CREATE INDEX IF NOT EXISTS idx_factory_imports_uploaded ON factory_code_imports(started_at DESC);
