...
-- Index
CREATE INDEX IF NOT EXISTS idx_config_lists_company ON company_config_lists(company_id);
CREATE INDEX IF NOT EXISTS idx_config_lists_name ON company_config_lists(company_id, list_name);
