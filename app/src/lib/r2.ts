 ...
 * 
 * This module provides a server-side R2 adapter for file storage operations.
 * It handles upload, download, delete, and URL generation for R2 objects.
 * 
 * IMPORTANT: This module should only be used server-side.
 * The R2 secret key is never exposed to the browser.
 */
...
export function isR2Configured(): boolean {
  return !!(env.r2Endpoint && env.r2AccessKeyId && env.r2SecretAccessKey && env.r2Bucket)
}
