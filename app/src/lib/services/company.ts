...
function withCompanyAliases(company: Company): Company {
  return {
    ...company,
    nameEn: company.name_en,
    nameAr: company.name_ar,
    legalNameEn: company.legal_name_en ?? undefined,
    legalNameAr: company.legal_name_ar ?? undefined,
    ...
    bankCurrency: company.bank_currency,
    ...
    defaultWeightUnit: company.default_weight_unit,
    defaultPackingUnit: company.default_packing_unit,
    defaultIncoterm: company.default_incoterm,
    defaultPaymentTerms: company.default_payment_terms,
    defaultDeliveryTerms: company.default_delivery_terms,
    defaultPreparedBy: company.default_prepared_by,
    showSignature: company.show_signature,
    showStamp: company.show_stamp,
  }
}
...
export class CompanyService {
  ...
  async getUserCompanies(context: RequestContext): Promise<Company[]> {
    ...
    return (data || []).map(withCompanyAliases)
  }
  ...
  async getCompanyById(id: string, context: RequestContext): Promise<Company> {
    ...
    return withCompanyAliases(data)
  }
