    ...
    <div className="min-h-screen bg-sand-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="card p-6">
          <h2 className="text-lg font-semibold text-brand-900 mb-6">{t('Sign In', 'تسجيل الدخول')}</h2>

          {error && (
            <div id="login-error" role="alert" className="flex items-center gap-2 p-3 bg-red-50 border border-red-200 rounded-lg text-sm text-red-700 mb-4">
              <AlertCircle size={16} />
              <span>{error}</span>
            </div>
          )}
