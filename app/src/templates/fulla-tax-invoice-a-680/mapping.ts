...
/* ── Tax Invoice A — Template Definition ───────────────── */
export const TEMPLATE_DEFINITION: FullaTemplateDefinition = {
  ...
  descriptionAr: 'تصميم فاتورة ضريبية شركة فولا أ مع رأس وبيانات وعميل وجدول وشروط وإجماليات ومعلومات بنكية',
  documentType: 'TINV',
  version: '1.0.0',
...
export const FIELD_MAPPINGS: FieldMapping[] = [
  ...
  // Shipping terms
  { source: 'shipping.incoterm', label: 'Incoterm', labelAr: 'الشرط التجاري', section: 'shipping' },
  { source: 'shipping.portOfLoading', label: 'Port of Loading', labelAr: 'ميناء التحميل', section: 'shipping' },
  { source: 'shipping.portOfDischarge', label: 'Port of Discharge', labelAr: 'ميناء التفريغ', section: 'shipping' },
  { source: 'shipping.freightTerms', label: 'Freight Terms', labelAr: 'شروط النقل', section: 'shipping' },
  { source: 'shipping.shippingMethod', label: 'Shipping Method', labelAr: 'طريقة الشحن', section: 'shipping' },
  ...
  // Signature / stamp
  { source: 'preparedBy', label: 'Prepared By', labelAr: 'أعدّها', section: 'signature' },
...
export const SECTIONS = {
  metadata: { en: 'Document Information', ar: 'معلومات المستند' },
  seller: { en: 'Seller Information', ar: 'بيانات البائع' },
  buyer: { en: 'Buyer / Customer', ar: 'المشتري / العميل' },
  items: { en: 'Material Details', ar: 'تفاصيل المواد' },
  shipping: { en: 'Shipping & Delivery Terms', ar: 'شروط الشحن والتسليم' },
  bank: { en: 'Bank Details', ar: 'تفاصيل البنك' },
  totals: { en: 'Financial Summary', ar: 'الملخص المالي' },
  signature: { en: 'Prepared By / Authorization', ar: 'أعدّها / التفويض' },
